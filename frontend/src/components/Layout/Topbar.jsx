    ...
    <div className="w-full relative">
      <div className="flex items-center justify-between">
        <RxHamburgerMenu
          ...
          className="h-4 w-4 cursor-pointer sm:hidden flex"
        />
        <Link to={`/`}>
          <h2 className="uppercase sm:flex hidden cursor-pointer font-bold">
            Stylehive
          </h2>
        </Link>
        <div className="flex items-center justify-between gap-10">
          ...
          <div className="flex items-center justify-between sm:gap-6 gap-3 sm:pr-2 pr-0">
            ...
            <div
              ...
              className="bg-neutral-200 relative dark:bg-neutral-800 p-2 rounded-full cursor-pointer"
            >
              <HiOutlineShoppingBag className="h-4 w-4" />
              <div className="text-xs absolute px-[5px] py-[0.2px] rounded-full -bottom-[2px] -right-1 bg-neutral-700 text-neutral-200">
                2
              </div>
            </div>
            <button
              onClick={handleThemeChange}
              className="relative p-4 border border-neutral-300 dark:border-neutral-700 rounded-md flex items-center justify-center cursor-pointer"
            >
      ...
      {open && (
        <div
          ref={menuRef}
          className="absolute flex justify-center inset-x-0 top-10 max-w-[70%] h-[calc(100vh-10rem)] bg-neutral-200 dark:bg-neutral-800 rounded-md shadow-aceternity"
        >
          <div className="md:hidden flex flex-col items-start gap-2 text-sm font-semibold p-4 pt-8 text-neutral-600 hover:text-neutral-500 cursor-pointer w-full h-full">
            <Link to={"/"}>
              <h2 className="text-2xl font-semibold mb-4 tracking-wider text-neutral-800 dark:text-neutral-200">
                Stylehive
              </h2>
            </Link>
