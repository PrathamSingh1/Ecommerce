...
const FilterSidebar = () => {
  ...
  return (
    <div className="p-4 bg-background text-foreground h-full">
      <h3 className="text-xl font-medium mb-4">Filter</h3>

      {/* Category Filter */}
      <div className="mb-6">
        <label className="block text-gray-600 dark:text-neutral-300 font-medium mb-2">
          Category
        </label>
          ...
          return (
            <div key={category} className="flex items-center mb-1">
              <input
                ...
                className="mr-2 h-4 w-4 text-blue-500 ring-gray-300 focus:ring-blue-400 border-gray-300"
              />
