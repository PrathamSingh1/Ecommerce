...
const Footer = () => {
  return (
    <footer className="bg-background text-foreground py-12 pl-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 lg:px-0 px-4 gap-8">
        <div>
          <h3 className="text-lg text-neutral-800 dark:text-neutral-500 font-semibold">
            Newsletter
          </h3>
          ...
          <p className="font-medium text-sm text-neutral-500 mb-6">
            Sign up and get 10% off your first order.
          </p>
          <form className="flex">
            <input
              className="p-3 w-full text-sm border-t border-l border-b border-neutral-300 dark:border-neutral-600 rounded-l-md outline-none"
              type="email"
        ...
        <div>
          ...
          <ul className="space-y-2 text-neutral-600">
            <li>
              <Link
                className="hover:text-neutral-500 dark:text-neutral-400 transition-colors"
                to={"#"}
              >
                Men's Top Wear
              </Link>
        ...
        {/* Follow Links */}
        <div>
          <h3 className="text-lg text-neutral-500 dark:text-neutral-400 mb-4">
            Follow Us
          </h3>
