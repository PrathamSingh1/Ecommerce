        ...
        <div className="p-4 sm:p-6 rounded-lg border">
          ...
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            <div>
              ...
              <p>{new Date(orderDetails.creratedAt).toLocaleDateString()}</p>
            </div>
          ...
          <div className="grid gird-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
            <div>
                    ...
                    <tr key={item.productId} className="border-b">
                      <td className="py-2 px-4 flex items-center">
                        ...
                        <Link
                          ...
                          className="text-blue-400 dark:text-neutral-400 hover:underline"
                        >
                          {item.name}
                        </Link>
                      </td>
          ...
          <Link
            to="/my-orders"
            className="text-blue-400 dark:text-neutral-300 hover:underline"
          >
            Back to My Orders
          </Link>
        </div>
